...
Object object_nameLiteralOrLoadReg(const Object* src, char* buffer, const size_t bufferLen) {
    ...
    case OBJECT_TYPE_REGISTER:
        ...
        return *src;
    case OBJECT_TYPE_SYMBOL: {
        // Closure upvalue: value already loaded as %upval.<idx>
        ...
        // Function reference: use the global function symbol name
        ...
        // Function argument: already in register %var.<idx>, no load needed
